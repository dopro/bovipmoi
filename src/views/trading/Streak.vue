                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide swiper-slide-active">
                                                <div class="swiper-slide-inner"><svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        class="swiper-slide-text">Đăng ký fionech</span></div>
                                            </div>
...
@media screen and (min-width: 1024px) {
  .wrapper:not(.Home):not(.Faqs):not(.FaqsDetail):not(.Signup-with-email):not(
      .SignupMethod
    ):not(.Oauth):not(.Login):not(.Forgot):not(.Resend):not(.Reset):not(
      .VerifyAccount
    )
...
.nav-tabs,
.item.active[data-v-d6d779c0]:before {
  content: "";
  height: 4px;
  width: 160px;
  border-radius: 2px;
