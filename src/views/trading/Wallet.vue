      ...
      <div data-v-84c9a680 class="w-full h-48 subBanner aothe">
        <div class="container h-full flex items-center info justify-between">
          <div class="flex flex-col justify-center relative">
            ...
            <p class="price mr-2" v-else>********</p>
          </div>
          <div
            class="cursor-pointer hidden-white"
            @click="isHiddenBalance = !isHiddenBalance"
          >
            <feather-icon
              style="top: 5px"
              icon="EyeIcon"
              svgClasses="w-6 h-5"
              v-if="isHiddenBalance"
            ></feather-icon>
            <feather-icon
              style="top: 5px"
              icon="EyeOffIcon"
          ...
          <div class="showV" :class="{ block: showVC }">
            <div class="box-coin-wrapper">
              ...
              <div class="vx-row fixRow-boxCoin">
                <div
                  class="vx-col w-full mb-3 fixCol-boxCoin"
                    ...
                    <div class="boxCoin-body">
                      <div class="leftBox flex flex-col sm:flex-row">
                        ...
                        <div class="flex flex-col">
                          <span class="uppercase font-bold">BẢO TRÌ</span>
                          <span class="capitalize colorGray">BẢO TRÌ</span>
                        </div>
                      </div>
                      <div class="rightBox">
                  ...
                  <div class="boxCoin" v-if="getSetSys.isActiveWalletETH">
                    ...
                    <div class="boxCoinFooter">
                      <div>
                        ...
                        <a
                          href="javascript:;"
                          @click.stop="showPopNapRutTien('USDT')"
                          >Nạp Tiền</a
                        >
                      </div>
                      <div>
