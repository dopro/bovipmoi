          ...
          <div class="container h-full">
            <div class="vx-row h-full items-center">
              <div class="vx-col lg:w-6/12">
                <p
                  data-v-e34fad3a
                  class="font-30 font-18m font-weight-700 color-white line-height-normal mb-4"
                >
                ...
                <vs-button
                  data-v-e34fad3a
                  class="btn button primary btn-green btn-large"
                  color="success"
                  type="filled"
                        ...
                        <div class="groupButton flex mb-4 relative">
                          <div class="copy-btn">
                            <input
                              ...
                              readonly="readonly"
                              disabled
                              class="form-control text-base pl-2 copy-btn-input"
                            />
                            <div>
                              <button
                                class="cursor-pointer copy-btn-button"
                        ...
                        <div class="groupButton flex mb-4 relative">
                          <div class="copy-btn-2">
                            <input
                              ...
                              readonly="readonly"
                              disabled
                              class="form-control text-base pl-2 copy-btn-input-2"
                            />
                            <button
                              class="cursor-pointer copy-btn-button-2 aomalam"
                  ...
                  <div>
                    <div class="textContent">
                      ...
                      <p class="color-white-50 mb-0 des">
                        Mời bạn bè đăng ký Dbino qua liên kết
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="textContent">
                      ...
                      <p class="color-white-50 mb-0 des">
                        Bạn của bạn (F1) đồng ý lời mời, hoàn tất đăng ký và
                        giao dịch
                      </p>
                    </div>
                  </div>
                ...
                <div class="flex items-center">
                  ...
                  <div>
                    <div class="textContent">
                      ...
                      <p class="color-white-50 mb-0 des">
                        Bạn sẽ nhận được hoa hồng tương ứng từ đối tác của bạn
                      </p>
                    </div>
                  </div>
                </div>
    ...
    <div v-else class="affiliatePage pt-8">
      <div class="w-full">
        <vs-tabs alignment="center">
          <vs-tab
            label="Tổng Quan"
            @click="(showGobal = true), (showCom = false), (showqlHt = false)"
          >
          </vs-tab>
          <vs-tab
            label="Hoa Hồng"
          ...
          <vs-tab
            ...
            @click="(showGobal = false), (showCom = false), (showqlHt = true)"
          >
          </vs-tab>
        </vs-tabs>
        <div class="m-6">
                ...
                <div class="vx-row">
                  <div class="vx-col w-full lg:w-1/3 mb-4">
                    <div class="boxBasic bgSecondary borderSecondary">
                      ...
                      <div class="body">
                        <h5
                          class="nextRankCondition colorSecondary text-left mb-3"
                        >
                          Điều kiện Cấp bậc
                        </h5>
                        <div class="vx-row">
                  ...
                  <div class="vx-col w-full lg:w-1/3 mb-4">
                    <div class="affiliateInfo bgSecondary borderSecondary">
                      <div class="referralSponsor">
                        <p class="mb-0">
                          <span class="text-xs colorSecondary mb-2 mr-2"
                        ...
                        <div class="vx-row">
                          ...
                          <div class="vx-col lg:w-8/12">
                            ...
                            <p class="flex items-center">
                              ...
                              />
                              <a
                                :href="`mailto:louis00238@gmail.com`"
                                class="elipText white text-base ml-2 getIntouch-value"
                                >contact@Dibino.trade</a
                              >
              ...
              >
                ...
                <div class="affCommissionControl items-end flex flex-wrap">
                  <div class="blockLine flex flex-col mr-3">
                    ...
                    <v-select
                      class="w-64 relative hidden xl:block"
                    ...
                    <div class="block xl:hidden">
                      <vs-button
                        ...
                        @click="searchCapBac"
                        class="mr-2"
                        >Hoa hồng giao dịch</vs-button
                      >
                      <vs-button
                        color="#4d4e4e"
                        type="filled"
                        @click="searchCapBac"
                        >Hoa hồng thành viên VIP</vs-button
                      >
                    </div>
                  </div>
                  ...
                  <div class="flex flex-wrap">
                    <div class="relative colFirst lg:mr-5 align-middle">
                      ...
                      <div class="fix-colFirst">
                        <button
                          class="btn search btnSearchType mr-3 button cursor-pointer"
                          :class="{
                            active: showActiveLv,
                            primary: showActiveLv,
                          }"
                      ...
                      <div class="lg:ml-8">
                        ...
                        <div class="flex">
                          <v-select
                            ...
                            class="w-32 relative mr-4 fix-width"
      ...
      <vs-popup title="Trading Comission" :active.sync="popupActiveCommission">
        <img
          width="100%"
          :src="require('@/assets/images/sky/aff_rank_commission.jpg')"
        />
      </vs-popup>
    </div>
  </div>
...
export default {
  ...
  methods: {
    checkPreBuy() {
      if (this.isDongY1 === true && this.isDongY2 === true) return true;
      return false;
    },
...
.affiliatePage .banner {
  background-image: url("~@/assets/images/sky/affiliate_bg.png");
}
