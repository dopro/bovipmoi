    ...
    <div class="vx-row m-0">
          ...
          <div class="relative chartBox">
            ...
            <div class="slider sidebarMobile lg:hidden" style="height: 100%">
              <div class="slidercontent">
                ...
                >
                  <span
                    class="font-12 zIndex99 text-center"
                    style="color: rgb(49, 186, 160)"
                    >{{ CSBUY ? CSBUY : 50 }}%</span
                  >
                  <vs-progress
                    :style="`width: ${widthProgress}px; margin-left: 10px;`"
                    class="bg-red progress"
                    :height="4"
                    :percent="[CSBUY ? CSBUY : 50]"
                    color="success"
                  ></vs-progress>
                  <span
                    class="font-12 zIndex99 text-center"
                    style="color: rgb(252, 95, 95)"
                    >{{ CSSELL ? CSSELL : 50 }}%</span
                  >
                </div>
              </div>
            </div>
      ...
      <div class="vx-col w-full rightBar c-desktop trans">
        <div class="pc block">
          <div class="mb-6">
            ...
            <div class="vx-row m-0 mt-2">
              ...
              <div class="item-col md:w-6/12 w-full text-center mt-2 num1">
                <vs-input
                  @keyup="nhapBetAmount"
                  class="w-full inp d1123 fix-dollar"
                  icon-pack="feather"
          ...
          <div class="lg:relative mb-10">
            <div class="text-center">
              <div class="profitPercent mb-2">
                Lợi nhuận <span class="color-green">95%</span>
              </div>
          ...
          <div class="lg:relative mb-5 mt-10">
            ...
            <vs-button
              ...
              :disabled="!isBet"
              class="w-full h-12 font-bold mb-3 btn-buy-sell btn-buy"
              color="success"
              type="relief"
              :class="{ disabled: !isBet }"
            >
              MUA
              <feather-icon
                style="top: 5px"
            ...
            >
              ...
              >
                <p
                  class="font-14 mb-0 text-timeDown"
                ...
                <p
                  class="mb-0 font-bold ml-1 timer_counter second text-time"
                  style="line-height: normal; color: black"
                  :class="{ 'text-danger': !isBet }"
                >
                  {{ seconDown }}s
                </p>
            ...
            <vs-button
              ...
              :disabled="!isBet"
              class="w-full h-12 font-bold btn-buy-sell btn-sell"
              color="danger"
              type="relief"
              :class="{ disabled: !isBet }"
            >
        ...
        <div class="mobile hidden">
          <div
            class="sidebarPC relative"
            v-if="classLandscape !== 'landscape-primary'"
          >
            <vs-progress
              class="bg-red"
              :height="4"
            ...
            <div class="flex">
              ...
              <div class="flex relative" style="width: 55rem">
                <vs-input
                  ...
                  class="w-full betInput fix-dollar"
                  icon-pack="feather"
                  icon="icon-dollar-sign"
                  placeholder="10"
                  v-model="betAmount"
          ...
          <div
            class="lg:relative mt-4 text-center color_white"
            v-if="classLandscape === 'landscape-primary'"
          >
            <div class="text-center">Chỉ báo tâm lý</div>
            <vs-progress
          ...
          <div class="relative mb-5 mt-3">
            ...
            >
              <vs-button
                ...
                @click="BetBuySell('sell')"
                :disabled="!isBet"
                class="font-bold btn-buy-sell btn-sell"
                color="danger"
                type="relief"
                :class="{ disabled: !isBet }"
              >
              ...
              <vs-button
                ...
                @click="BetBuySell('buy')"
                :disabled="!isBet"
                class="font-bold btn-buy-sell btn-buy"
                color="success"
                type="relief"
                :class="{ disabled: !isBet }"
              >
          ...
          <div class="keyboard-input-wrap" :class="{ active: showMobileMenu }">
            ...
            <div
              class="keyboard"
              :class="{
                hiddenKey: !showMobileMenu,
                keyboardLandscape: classLandscape === 'landscape-primary',
              }"
            >
      ...
      <div
        :class="['c-body trans']"
        :style="`${isOpenSideBar && !isTablet ? 'width: 120px' : ''}`"
      ></div>
    </div>
      ...
      <div class="popupCongratulationContent">
        <div class="winLive flex justify-center">
          <div class="wrapNotify congratulation h-100">
            <div class="boxNotify">
              <img
                src="https://i.imgur.com/CPlQVxq.png"
                alt=""
                class="iconWin"
              />
              <div class="badgeDemo">
...
export default {
  ...
  mounted() {
    this.classLandscape = screen.orientation.type;
    this.addSound();
...
.c-desktop .profitPercent .color-green,
.profitPercent.color-light-blue {
  color: #27d37d !important;
}
...
.highcharts-plot-background {
  background: url("/assets/images/sky/world_map.svg");
}
