<template>
  <div id="tradeHisPage" class="tradeHistory">
      ...
      <div class="w-full">
        <div class="headerContent justify-between items-center mb-4">
          <div class="flex justify-between">
            <h1
              class="text-3xl white font-bold capitalize relative flex items-center"
            >
              Số liệu B.O
              <feather-icon
                icon="EyeIcon"
          ...
          <div class="wrap-chart">
            <div class="chart-instance">
              <div class="vx-row">
                ...
                <div
                  class="vx-col w-full lg:w-1/2 sm:mb-3 flex lg:items-center justify-center lg:justify-start div-total"
                >
                  <ul>
            ...
            <div class="p-8 userStat profits flex align-middle justify-around">
              <div class="wrap">
                ...
                <div class="info">
                  <p
                    class="name m-0"
                    style="color: hsla(0, 0%, 100%, 0.67) !important"
                  >
                    Lợi nhuận ròng
                  </p>
    ...
    <div class="vx-row mt-5">
      ...
      <div
        data-v-0850e8cd
        class="table-responsive tableTradeHis relative"
        v-if="!isMobile"
      >
        <table
          data-v-0850e8cd
      ...
      <div
        class="bostats w-full p-4"
        v-if="isMobile && dataHisOrder && dataHisOrder[0]"
      >
        <div class="flex justify-between">
        ...
        <div class="flex justify-between items-stretch mt-4">
          ...
          <div class="btn-copy" @click="copy(dataHisOrder[0].oss)">
            Copy OrderId
          </div>
        </div>
        ...
        <div class="flex justify-between items-stretch mt-4">
          <div class="flex flex-col">
            <div>Giá mở</div>
            <div class="color_white">${{ dataHisOrder[0].o }}</div>
          </div>
          <div class="flex flex-col">
            <div>Giá đóng</div>
            <div class="color_white">${{ dataHisOrder[0].c }}</div>
          </div>
        </div>
        ...
        <div class="flex justify-between items-stretch mt-4">
          <div class="flex flex-col">
            <div>Giá trị</div>
            <div class="color_white">${{ dataHisOrder[0].ab }}</div>
          </div>
          <div class="flex flex-col">
            <div>Thanh toán</div>
...
.trade_history .tradeHistory .table-responsive[data-v-0850e8cd] {
  border: 1px solid #25253b !important;
}
