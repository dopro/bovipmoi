                ...
                <div v-if="tr.status != 1">
                  ...
                  >
                    <vs-button
                      ...
                      icon-pack="feather"
                      icon="icon-trash"
                      @click.stop="deleteWithdra(tr.id, indextr, 1)"
                    ></vs-button>
                  </vx-tooltip>
                  <vx-tooltip
                    v-if="tr.delete_status == 0"
                  ...
                  >
                    <vs-button
                      ...
                      icon-pack="feather"
                      icon="icon-check"
                      @click.stop="doneWithDrawl(tr.id, indextr, 1)"
                    ></vs-button>
                  </vx-tooltip>
                  <vx-tooltip
                    v-else
                  ...
                  >
                    <vs-button
                      ...
                      @click.stop="deleteWithdra(tr.id, indextr, 0)"
                    ></vs-button>
                  </vx-tooltip>
                </div>
              </vs-td>
...
export default {
  ...
  methods: {
    doneWithDrawl(id, index, status) {
      ...
      AuthenticationService.doneWithDrawlCharge(obj).then((resp) => {
        let d = resp.data;
        if (d.success) {
          let gd = d;
          if (gd.success == 1) {
