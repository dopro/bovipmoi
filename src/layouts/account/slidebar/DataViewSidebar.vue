    ...
    >
      <div class="p-6">
        ...
        <span class="text-danger text-sm" v-show="errors.has('item-email')"
          >Nhập lại email (ít nhất 6 kí tự - nhiều nhất 200 kí tự)</span
        >
        ...
        <span class="text-danger text-sm" v-show="errors.has('item-nick')"
          >Nhập biệt danh (ít nhất 6 kí tự - nhiều nhất 20 kí tự)</span
        >
        ...
        <vs-input
          ...
          v-validate="'required'"
        />
        <span class="text-danger text-sm" v-show="errors.has('item-first_name')"
          >Nhập họ</span
        >
        ...
        <vs-input
          ...
          v-validate="'required'"
        />
        <span class="text-danger text-sm" v-show="errors.has('item-last_name')"
          >Nhập tên</span
        >
        ...
        <span
          ...
          v-show="errors.has('item-wallet_sys')"
          >{{ errors.first("item-wallet_sys") }}</span
        >
        ...
        <span
          class="text-danger text-sm"
          v-show="errors.has('item-wallet_btc')"
          >{{ errors.first("item-wallet_btc") }}</span
        >
        ...
        <span
          class="text-danger text-sm"
          v-show="errors.has('item-wallet_eth')"
          >{{ errors.first("item-wallet_eth") }}</span
        >
        ...
        <span
          class="text-danger text-sm"
          v-show="errors.has('item-wallet_usdt')"
          >{{ errors.first("item-wallet_usdt") }}</span
        >
