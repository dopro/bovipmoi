...
export default {
  ...
  withdrawalUsdtVND(obj) {
    return Api().post(`api/pay/vnd/rut`, obj);
  },
  ...
  withdrawalUsdtBSC(obj) {
    ...
    return Api().post("api/pay/usdt/rut", obj);
  },
  ...
  depositUSDT(obj) {
    return Api().post(`api/pay/usdt/nap`, obj);
  },
  getAddressCoin(coin) {
  ...
  doneBillByID(obj) {
    return ApiAdmin().patch("api/trades/doneBillByID", obj);
  },
  ...
  doneWithDrawlCharge(obj) {
    return ApiAdmin().post("api/trades/doneRefuseWithdrawal", obj); //doneWithDrawlCharge
  },
  doneRefuseWithDrawalByID(obj) {
    return ApiAdmin().post("api/trades/doneWithDrawlCharge", obj); //doneRefuseWithdrawal
  },
