  ...
  <div class="boxFix">
    ...
    >
      ...
      >
        ...
        <div
          class="header-sidebar p-6 fixed flex items-center justify-between flex-col w-full"
        >
...
.logoLogin {
  background-image: url("https://i.imgur.com/Aw0gxgt.png");
  display: block;
  height: 40px;
  width: 170px;
