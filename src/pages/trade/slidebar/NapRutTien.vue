              ...
              >
                ...
                <div class="listUnits shadow">
                  ...
                  <div
                    ...
                    v-if="getSetSys.isActiveWalletVND && typePay == 'VND'"
                  >
                  ...
                  <div
                    ...
                    v-if="getSetSys.isActiveWalletUSDT && typePay == 'USDT'"
                  >
          ...
          <div class="boxAddress">
              ...
              <div class="transfer-network">
                ...
                <div class="deposit_widthdraw_box">
                  ...
                  <div class="form-group relative" v-if="!activeNRT">
                    ...
                    <input
                      type="text"
                      :placeholder="`${isActiveSelectTransPaypal ? 'Nhập biệt danh người nhận' : 'Nhập tài khoản nhận'}`"
                      class="form-control"
                    />
                  </div>
            ...
            <div v-if="isVND" :class="isMobile ? 'scrollMobile' : ''">
              <div class="deposit_widthdraw_box" v-if="activeNRT">
                ...
                <div class="text-center address">
                  <div class="p-3">
                    <div>Vui Lòng Chuyển Tiền Tới Địa Chỉ Ví Bên Dưới</div>
                    <div>-------</div>
                    <div>Mạng Trc20 : TMFKuyh72Egaz8q1kcQqoW9aXF6WV6JiPx</div>
                    <div>-------</div>
                    <div>
                      Mạng Bep20 : ...............BẢO TRÌ...............
                    </div>
                  ...
                  <i
                    >* Lưu ý: Hệ Thống Sẽ Cộng Tiền Sau Khi Bạn Chuyển Thành
                    Công , Nếu Chưa Thấy Cộng Tiền Sau Khi Chuyển Quá 5p Vui
                    Lòng Liên Hệ CSKH Để Khiếu Nại. *</i
                  >
                  <span class="noted"
                    >1 USD =
                    ...
                    <div class="address">
                      <div class="form-group relative">
                        ...
                        <input
                          ...
                          v-model="amount"
                          decimal="true"
                          :placeholder="`Số tiền tối thiểu: ${activeNRT ? getSetSys.minDepositUSDT : getSetSys.minWithdrawalUSDT} USDT`"
                    ...
                    <div class="md:w-full text-center">
                      <div class="address">
                        ...
                        <vs-button
                          ...
                          class="vs-con-loading__container buttonCommon ml-2"
                          color="red"
                          type="filled"
                          @click="DepositUSDT()"
                          >Nạp tiền</vs-button
              ...
              >
                ...
                <div class="form-group relative">
                  ...
                  <input
                    ...
                    :placeholder="`${isActiveSelectTransNB ? 'Nhập biệt danh người nhận' : 'Nhập địa chỉ nhận'}`"
                    class="form-control"
                  />
                </div>
                <div class="form-group relative">
...
export default {
  ...
  methods: {
    ...
    DepositUSDT() {
      ...
      AuthenticationService.depositUSDT(obj).then((res) => {
        let d = res.data;
    ...
    WithdrawalOKPay() {
      ...
      let obj = {
        ...
        nw: "",
        code: this.code2FA,
        al: amount * getSetSys.quotePriceVND, // Số tiền VNĐ nhập
