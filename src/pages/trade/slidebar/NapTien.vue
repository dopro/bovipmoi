  ...
  >
    ...
    >
      <div class="p-4" v-if="!isNap">
        <vx-card subtitle="Số tiền nạp" class="mb-5 mt-5">
        ...
        <vx-card subtitle="Phương thức thanh toán" class="mb-5">
          <div class="vx-row mb-3">
            <div class="vx-col w-full">
              ...
              <vs-collapse>
                <vs-collapse-item class="p-0">
                  ...
                  <h6 class="mt-1 mb-1" style="color: #778db9; font-size: 12px">
                    VÍ ĐIỆN TỬ
                  </h6>
                  <!-- <a class="flex mt-2 mb-2" href="javascript:void(0);">
      ...
      <div class="p-4" v-else>
        ...
        <p class="p-3">
          Có 1 cửa sổ Popup sẽ được bật lên, vui lòng thánh toán để hoàn thành.
        </p>
        <i>Lưu ý: </i> Nếu bạn không thấy của sổ Popup bật lên xin vui lòng vào
        trình duyệt Cài đặt -> bỏ chặn Cửa sổ bật lên
      </div>
    </VuePerfectScrollbar>
    <div
      class="flex flex-wrap items-center p-6"
      slot="footer"
      style="color: #828282; font-size: 11px"
    >
      <span>
        Khi gửi tiền bằng thẻ ngân hàng, số tiền bị trừ đi từ thẻ sẽ được tính
        theo tỷ giá hối đoái của ngân hàng khách hàng.
      </span>
      <span>
        Bạn không thể rút tiền thưởng về, nhưng có thể sử dụng chúng để giao
        dịch và rút tiền lãi. Tiền thưởng không ảnh hưởng đến việc rút tiền.
      </span>
    </div>
  </vs-sidebar>
</template>
