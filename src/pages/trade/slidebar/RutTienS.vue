            ...
            <div class="vx-col w-full">
              <div class="imgShow absolute" style="right: 100px">
                <img
                  width="35"
                  :src="
                    require('@/assets/images/sky/icon_bank/tether-mini.svg')
                  "
                />
              </div>
              <vs-collapse>
          ...
          <vs-tab label="Nội bộ" @click="withDefault = false">
            <div>
              ...
              <div class="centerx default-input relative mt-6">
                ...
                />
                <span
                  class="allmax absolute cursor-pointer"
                  @click="enterAllPriceNB"
                  >Tất cả</span
                >
              </div>
              <div class="centerx default-input relative mt-6">
                <span class="title z-10 absolute text-xs"
                  >Biệt danh người nhận</span
                >
                <vs-input
                  size="large"
                  class="inputx w-full"
                  placeholder="Biệt danh người nhận"
                  v-model="nickNameNB"
                />
              </div>
              <div class="centerx default-input relative mt-6">
                <span class="title z-10 absolute text-xs"
                  >Ghi chú ( không bắt buộc )</span
                >
                <vs-input
                  size="large"
                  class="inputx w-full"
            ...
            <div>
              ...
              <div class="centerx default-input relative mt-6">
                ...
                <vs-input
                  ...
                  class="inputx w-full"
                  placeholder="Số tiền tối thiểu: 5 USDT"
                  v-model="amountRutUSDT"
                />
                <span
                  class="allmax absolute cursor-pointer"
                  @click="enterAllPriceUSDT"
                  >Tất cả</span
                >
              </div>
              <div class="centerx default-input relative mt-6">
  ...
  methods: {
    ...
    Withdrawal() {
      if (!this.withDefault) {
        ...
        AuthenticationService.withdrawalUser(obj).then((res) => {
          if (res.data.success) {
        ...
        AuthenticationService.withdrawalUsdt(obj).then((res) => {
          if (res.data.success) {
            this.blObj.balance = this.blObj.balance - tongphi;
