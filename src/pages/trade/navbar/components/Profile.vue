<template>
  ...
  >
    ...
    <div>
      <div data-v-3bbff296 class="nav-streak">
        <a
          ...
          class="nav-link p-0 btn-streak-challenge"
        >
    ...
    <div
      class="con-img ml-3 mr-3 info-money cursor-pointer"
      ...
      <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
        <div class="flex cursor-pointer">
          ...
          <feather-icon
            ...
            svgClasses="w-6 h-6 text-down ml-2"
          />
        </div>
            ...
            <div>
              ...
              <div class="balance cursor-pointer" @click="changeAccount(1)">
                ...
                >
                  <span
                    data-v-12346e9f=""
                    class="cursor-pointer w-4 feather-icon select-none relative"
                    ><svg
                      data-v-12346e9f=""
    ...
    <div class="con-img ml-3 mr-3 cursor-pointer mhelper">
      <a
        href="https://tawk.to/chat/667a3f759d7f358570d30672/1i16ofott"
        class="con-img ml-3 mr-3 cursor-pointer mhelper"
      >
        <div class="con-img ml-3 mr-3 cursor-pointer mhelper">
          <svg
            class="block text-center h-5"
          ...
          >
            <g clip-path="url(#clip0_17_2)">
              <path
                d="M10.506 18.428H14.467C14.7792 18.4281 15.0883 18.3667 15.3768 18.2473C15.6652 18.1279 15.9273 17.9528 16.1481 17.7321C16.3688 17.5113 16.5439 17.2492 16.6633 16.9608C16.7827 16.6723 16.8441 16.3632 16.844 16.051V13.675"
                stroke="#C1C5DB"
                stroke-width="2"
                stroke-miterlimit="10"
                stroke-linecap="square"
              />
              <path
                d="M4.961 9.71399H1V13.675C1 14.0951 1.16689 14.498 1.46394 14.795C1.761 15.0921 2.1639 15.259 2.584 15.259H4.961V9.71399Z"
                stroke="#C1C5DB"
                stroke-width="2"
                stroke-miterlimit="10"
                stroke-linecap="square"
              />
              <path
                d="M16.844 9.71399H12.883V15.259H15.26C15.6801 15.259 16.083 15.0921 16.3801 14.795C16.6771 14.498 16.844 14.0951 16.844 13.675V9.71399Z"
                stroke="#C1C5DB"
                stroke-width="2"
                stroke-miterlimit="10"
                stroke-linecap="square"
              />
              <path
                d="M16.844 9.714V8.922C16.844 7.88167 16.6391 6.85152 16.241 5.89038C15.8429 4.92924 15.2593 4.05593 14.5237 3.3203C13.7881 2.58467 12.9148 2.00114 11.9536 1.60303C10.9925 1.20491 9.96233 1 8.922 1C6.82095 1 4.80596 1.83464 3.3203 3.3203C1.83464 4.80596 1 6.82095 1 8.922V9.714"
                stroke="#C1C5DB"
                stroke-width="2"
                stroke-miterlimit="10"
                stroke-linecap="square"
          ...
          <span style="color: #fff">Trợ Giúp</span>
        </div>
      </a>
    </div>
    ...
    <div
      ...
      class="con-img ml-3 mr-3 cursor-pointer mdot hidden xl:block"
...
.header .leftHeader {
  border-right: 1px solid rgb(29, 25, 25);
}
...
.add-money {
  ...
  background: linear-gradient(180deg, #24d351, #24d351 50%, #24d351) !important;
  color: #fff !important;
  font-weight: 600;
  border-radius: 10px;
}
...
.nav-streak-rewards {
  ...
  border-radius: 6px;
  background: linear-gradient(133deg, #222225, #222225 0, #222225);
  text-align: left;
  position: relative;
}
#rightNav a span {
