      ...
      <div class="topSidebar">
        <div class="logo py-4 h-20">
          <feather-icon
            style="color: #fff"
            icon="XIcon"
            svgClasses="w-12 h-12 mx-4 cursor-pointer"
        ...
        <div class="nav-item btn-nav-item-new">
          <vs-button class="btn-link" @click="quickDeposit()"
            >NẠP TIỀN</vs-button
          >
        </div>
        <div class="text-section">Kiếm Tiền</div>
        ...
        <div class="text-section mt-12">Quản Lý Hồ Sơ</div>
        ...
        <div class="text-section mt-12">Cài Đặt Và Trợ Giúp</div>
        ...
        <div class="nav-item btn-nav-item-new">
          ...
          >
            ...
            <span class="textLink">Trợ Giúp</span>
          </a>
        </div>
      </div>
          ...
          <div class="bottomSidebar btn-nav-item-new block lg:hidden">
            <div class="nav-item">
              <a
                href.prevent
                @click="logOut()"
                class="nav-link cursor-pointer items-center"
              >
                <span class="mr-0"
                  ><feather-icon
                    style="color: #fff"
            ...
            <a href.prevent @click="logOut()" class="nav-link cursor-pointer">
              <span class="mb-2"
                ><feather-icon
                  ...
                  icon="LogOutIcon"
                  svgClasses="w-5 h-5"
                  class="block text-center h-5 btn-logout"
              /></span>
              <span class="textLink">{{ $t("Logout") || "Logout" }}</span>
            </a>
          </div>
...
.btn-link {
  ...
  font-weight: 700;
  width: 100%;
  background-color: #1dc978 !important;
  border-radius: 5px;
}
