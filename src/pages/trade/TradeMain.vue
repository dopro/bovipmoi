...
export default {
  ...
  methods: {
    ...
    updateNavbar(val) {
      if (val == "static")
        this.updateNavbarColor(this.isThemeDark ? "#090f3e" : "#fff");
      this.navbarType = val;
    },
